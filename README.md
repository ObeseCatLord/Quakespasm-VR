...
| `cl_move_maxpacketbytes` | `1200` | Soft size cap for bundled movement packets. The sender keeps the newest commands that fit, so normal/VR clients get a longer recovery window without creating oversized upstream UDP packets. |
