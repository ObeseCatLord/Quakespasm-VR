...
| `sv_replacement_packetdup` | `1` | Duplicates the first replacement-delta datagram for each server update. This protects the move ack and highest-priority state against isolated downstream UDP loss without duplicating every split update part. |
