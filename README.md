...
| `sv_coop_progression_item_respawn_time` | `5` | Co-op | Progression pickup respawn delay in seconds. |
| `sv_coop_progression_item_respawn_classes` | `item_jboots item_jboots_timed item_artifact_envirosuit item_artifact_wetsuit item_artifact_airtank item_artifact_divingsuit` | Co-op | Classes treated as progression respawn items. Suit-like classnames also respawn automatically. |
