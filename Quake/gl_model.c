...
complete rerelease signature was verified by common.c.  This both verifies the
VRIK feature's required assets and supplies its common multiplayer avatar,
without allowing higher-priority mod files to replace the trusted rig.
===============================
*/
static qmodel_t *Mod_LoadVerifiedRereleasePlayerMD5 (void)
{
